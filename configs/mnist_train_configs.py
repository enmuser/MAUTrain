...
def configs():
    ...
    parser.add_argument('--max_iterations', type=int, default=260000)
    ...
    parser.add_argument('--pretrained_model', type=str, default='/kaggle/input/movingmnist/model.ckpt-202000')
